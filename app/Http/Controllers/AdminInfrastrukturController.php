...
class AdminInfrastrukturController extends \crocodicstudio\crudbooster\controllers\CBController {

    public function __construct() {
        $this->table              = "infrastruktur";
        $this->primary_key        = "id";
        $this->title_field        = "id";
        $this->limit              = 20;
        ...
        $this->col = array();
		$this->col[] = array("label"=>"Jenis Infrastruktur","name"=>"infrastruktur_jenis" );
		...
		$this->form = array();
		$this->form[] = array("label"=>"Jenis Infrastruktur","name"=>"infrastruktur_jenis","type"=>"text","required"=>TRUE,"validation"=>"required|min:3|max:255");
