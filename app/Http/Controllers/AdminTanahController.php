...
class AdminTanahController extends \crocodicstudio\crudbooster\controllers\CBController {
    ...
    public function __construct() {
		...
		$this->col[] = array("label"=>"Kepemilikan","name"=>"tanah_milik" );
		$this->col[] = array("label"=>"Luas Tanah","name"=>"tanah_luas" );
